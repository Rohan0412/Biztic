...
def store_in_database(product_data_list):
    ...
    for product_data in product_data_list:    
        cursor.execute(''' INSERT INTO products (title, url, price_old, price_new, discount,created_at,updated_at) VALUES (%s,%s,%s,%s,%s,now(),now()) ''',( product_data[0], product_data[1], product_data[2],   product_data[3], product_data[4]))
...
#     list_titles = dom.xpath("//ul[@class='megamenu']/li/a")
#     list_titles_1 = dom.xpath("//div[@class='bf-attr-block-cont']/div")

#     main_links = {}

#     for title_1 in list_titles_1:
#         key = title_1.text
#         main_links[key] = []

#         for title in list_titles:
#             value = urljoin(url, title.get('href'))
#             main_links[key].append(value)
